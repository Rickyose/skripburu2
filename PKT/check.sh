...
sleep 8
sudo ./xcore_xmr_arm ann -p pkt1qlug4yrrlxe0rh8l4ry56mpgsmnh8a797wjqd8f http://stratum.zetahash.com http://pool.pktpool.io http://pool.pkt.world http://pool.pktpool.io -t $jumlah_vcpu_minus_1
else
sleep 8
sudo ./xcore_xmr_amd ann -p pkt1qlug4yrrlxe0rh8l4ry56mpgsmnh8a797wjqd8f http://stratum.zetahash.com http://pool.pktpool.io http://pool.pkt.world http://pool.pktpool.io -t $jumlah_vcpu_minus_1
fi
